...
public class DrawTable {
    ...
    public static void drawTableH(List<PrintResult> results, Equipamento equipamento) {
        ...
        table.append("<!DOCTYPE html><html><head><style>")
                ...
                .append("<body>")
                .append("<table><tr>")
                .append("<h2>").append(equipamento.getDipositivo()).append("</h2>")
                .append("<th>Data</td>");
        ...
        save(String.valueOf(table), equipamento.getDipositivo());
    }

    public static void drawTableV(List<PrintResult> results, Equipamento equipamento) {
        StringBuilder table = new StringBuilder();
